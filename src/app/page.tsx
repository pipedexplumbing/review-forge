  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center py-10 px-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-3xl space-y-12">
        ...
        {error && (
          <Card className="bg-red-50 border-red-200 shadow-lg rounded-lg">
            <CardHeader className="p-7">
              <CardTitle className="font-headline text-3xl text-red-800">Error</CardTitle>
            </CardHeader>
            <CardContent className="p-7 pt-0">
              <p className="font-body text-xl text-red-700">{error}</p>
            </CardContent>
          </Card>
        )}
